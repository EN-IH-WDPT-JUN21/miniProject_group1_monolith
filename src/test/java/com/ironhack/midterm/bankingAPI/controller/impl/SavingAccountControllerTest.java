...
class SavingAccountControllerTest {
    ...
    @Test
    void createSavingAccount_positive_accountCreated() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/admin/create_savings")
                ...
                .content(objectMapper.writeValueAsString(savingAccountDTO)))
                .andExpect(status().isCreated())
                .andReturn();
    }

    @Test
    void createSavingAccount_negative_ownerNotFound() throws Exception {
        SavingAccountDTO savingAccountDTO = new SavingAccountDTO(
                new BigDecimal("1000"),
                999999L,
                new BigDecimal("0.25"),
